...
All dispersal estimates comes from Fandos et al. 2023.[![DOI](https://zenodo.org/badge/416393431.svg)](https://zenodo.org/badge/latestdoi/416393431)
...
**The pipeline and workflow for analysing dispersal syndromes**
---------------------------------------------------------------
1. [Join dispersal estimates with biological and ecological traits](#1-Data-enquiry)
2. [Correlation between variables](#2-Data-preparation)
3. [Bayesian phylogenetic mixed models](#3-Dispersal-kernel-estimation)
4. [Results and plots from dispersal syndromes](#4-Results-analysis)
5. [Evaluating and cross-predicting dispersal estimates](#5-Summary-data-and-main-results)
