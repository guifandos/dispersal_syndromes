...
results_total_complete
best_weibull_average_median_model <- results_total_complete$model[[1]]$formula
# Formula without phylogeny
#best_weibull_average_median_model <- Weibull_median ~ PC1 + Latitude + body_mass + diet + habita_for + body_mass:diet + distance_mig + body_mass:PC1 + body_mass:habita_for
...
saveRDS(prediction_total, "prediction_between_within_clade_complex_Weibull_interactions_sensitivity_test.rds")
