...
best_weibull_average_median_model <- "Weibull_median ~ log_HWI + log_body_mass + habita_for + PC1 + diet + distance_mig + Latitude + log_body_mass:habita_for + log_body_mass:PC1 + log_body_mass:diet "
####### WITHIN-CLADE #######
...
saveRDS(prediction_total, "prediction_between_within_clade_complex2_Weibull_natal_model_complete.rds")
