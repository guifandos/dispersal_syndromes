...
prediction_complex_breeding <- readRDS("revision_analysis/results/predictions/weibull/median/breeding/prediction_between_within_clade_complex_Weibull_breeding_interactions.rds")
...
export_validation <- validation_long %>% 
  dplyr::select(-model) 
write.csv(export_validation, "revision_analysis/results/predictions/weibull/median/breeding/prediction_median_breeding.csv")
