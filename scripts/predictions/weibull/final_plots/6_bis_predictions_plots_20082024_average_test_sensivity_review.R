...
prediction_complex <- readRDS("revision_analysis/results/predictions/weibull/median/average/prediction_between_within_clade_complex_Weibull_interactions_sensitivity_test.rds")
...
prediction_simple_l <- readRDS("Exports/results/prediction/weibull/prediction_between_within_clade_latitude_Weibull.rds")
prediction_simple_d <- readRDS("Exports/results/prediction/weibull/prediction_between_within_clade_distance_mig_Weibull.rds")
prediction_simple_p <- readRDS("Exports/results/prediction/weibull/prediction_between_within_clade_PC1_Weibull.rds")
prediction_simple_die <- readRDS("Exports/results/prediction/weibull/prediction_between_within_clade_diet_Weibull.rds")
prediction_simple_hab <- readRDS("Exports/results/prediction/weibull/prediction_between_within_clade_habitat_Weibull.rds")
...
export_validation <- validation_long %>% 
  dplyr::select(-model) 
write.csv(export_validation, "prediction_average_sensivity_test_train.csv")
