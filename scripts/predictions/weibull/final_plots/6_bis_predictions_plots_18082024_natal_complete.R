...
prediction_complex_natal <- readRDS("revision_analysis/results/predictions/weibull/median/natal/prediction_between_within_clade_complex2_Weibull_natal_model_complete.rds")

prediction_complex_natal$complexity <- "total"

prediction_simple_b_natal <- readRDS("Exports/results/prediction_2/weibull/median/natal/prediction_between_within_clade_body_mass_weibull_natal.rds")
prediction_simple_h_natal <- readRDS("revision_analysis/results/predictions/weibull/median/natal/prediction_between_within_clade_HWI_Weibull_natal.rds")
prediction_simple_l_natal <- readRDS("Exports/results/prediction_2/weibull/median/natal/prediction_between_within_clade_latitude_weibull_natal.rds")
prediction_simple_d_natal <- readRDS("Exports/results/prediction_2/weibull/median/natal/prediction_between_within_clade_distance_mig_Weibull_natal.rds")
prediction_simple_p_natal <- readRDS("Exports/results/prediction_2/weibull/median/natal/prediction_between_within_clade_PC1_weibull_natal.rds")
prediction_simple_die_natal <- readRDS("Exports/results/prediction_2/weibull/median/natal/prediction_between_within_clade_diet_weibull_natal.rds")
prediction_simple_hab_natal <- readRDS("Exports/results/prediction_2/weibull/median/natal/prediction_between_within_clade_habitat_Weibull_natal.rds")
...
export_validation <- validation_long %>% 
  dplyr::select(-model) 
write.csv(export_validation, "revision_analysis/results/predictions/weibull/median/natal/prediction_median_natal_complete.csv")
