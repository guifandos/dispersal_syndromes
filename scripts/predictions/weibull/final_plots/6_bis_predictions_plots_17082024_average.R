...
prediction_complex <- readRDS("revision_analysis/results/predictions/weibull/median/average/prediction_between_within_clade_complex_Weibull.rds")
prediction_complex$complexity <- "total"

prediction_simple_b <- readRDS("revision_analysis/results/predictions/weibull/median/average/prediction_between_within_clade_body_mass_weibull.rds")
prediction_simple_h <- readRDS("revision_analysis/results/predictions/weibull/median/average/prediction_between_within_clade_HWI_weibull.rds")
prediction_simple_l <- readRDS("Exports/results/prediction_2/weibull/median/average/prediction_between_within_clade_Latitude_weibull.rds")
prediction_simple_d <- readRDS("Exports/results/prediction_2/weibull/median/average/prediction_between_within_clade_distance_mig_weibull.rds")
prediction_simple_p <- readRDS("Exports/results/prediction_2/weibull/median/average/prediction_between_within_clade_PC1_weibull.rds")
prediction_simple_die <- readRDS("Exports/results/prediction_2/weibull/median/average/prediction_between_within_clade_diet_weibull.rds")
prediction_simple_hab <- readRDS("Exports/results/prediction_2/weibull/median/average/prediction_between_within_clade_habita_for_weibull.rds")


names(prediction_complex)
head(prediction_simple_b)

prediction_total <- bind_rows(prediction_complex, prediction_simple_b, prediction_simple_h, prediction_simple_l, prediction_simple_d,
                              prediction_simple_p,prediction_simple_die,prediction_simple_hab)



validation <- prediction_total$validation 
validation$id <- c(1:nrow(validation)) 
prediction_total$id <- c(1:nrow(prediction_total)) 
validation_long <-
  prediction_total %>% 
...
export_validation <- validation_long %>% 
  dplyr::select(-model) 
write.csv(export_validation, "revision_analysis/results/predictions/weibull/median/average/prediction_median_average.csv")
...
table_prediction$complexity <- 
  recode_factor(table_prediction$complexity, "only_PC1"= "Life history", "only_latitude"= "Latitude", "only_body_mass"= "Body mass",
                 "only_HWI"= "HWI", "only_distance_mig"= "Distance migration", "only_diet"= "Diet", "only_habitat"= "Habitat", "total"= "Dispersal syndrome")
...
ggplot(sumrepdat2, aes(x = complexity, y = Mean_R2 , fill = type, group= type)) +
  ...
  coord_cartesian(ylim = c(-0.08, 0.8), clip = "on")  + theme(text = element_text(size = 20))       
