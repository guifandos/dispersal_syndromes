...
prediction_complex_breeding <- readRDS("revision_analysis/results/predictions/weibull/median/breeding/best_prediction_between_within_clade_complex_Weibull_breeding_interactions_test_sensitivity.rds")
...
prediction_simple_l_breeding <- readRDS("Exports/results/prediction/weibull/breeding/prediction_between_within_clade_latitude_Weibull_breeding.rds")
prediction_simple_d_breeding <- readRDS("Exports/results/prediction/weibull/breeding/prediction_between_within_clade_distance_mig_Weibull_breeding.rds")
prediction_simple_p_breeding <- readRDS("Exports/results/prediction/weibull/breeding/prediction_between_within_clade_PC1_Weibull_breeding.rds")
prediction_simple_die_breeding <- readRDS("Exports/results/prediction/weibull/breeding/prediction_between_within_clade_diet_Weibull_breeding.rds")
prediction_simple_hab_breeding <- readRDS("Exports/results/prediction/weibull/breeding/prediction_between_within_clade_habitat_Weibull_breeding.rds")
...
export_validation <- validation_long %>% 
  dplyr::select(-model) 
write.csv(export_validation, "prediction_median_breeding_sensivity_best_test_train.csv")
