...
prediction_complex_natal <- readRDS("revision_analysis/results/predictions/weibull/median/natal/prediction_between_within_clade_complex_Weibull_natal_interactions.rds")
...
export_validation <- validation_long %>% 
  dplyr::select(-model) 
write.csv(export_validation, "revision_analysis/results/predictions/weibull/median/natal/prediction_median_natal2.csv")
