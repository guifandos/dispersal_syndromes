...
prediction_complex_breeding <- readRDS("revision_analysis/results/predictions/weibull/median/breeding/prediction_between_within_clade_complex_Weibull_breeding_model_complete.rds")
prediction_complex_breeding$complexity <- "total"

prediction_simple_b_breeding <- readRDS("Exports/results/prediction_2/weibull/median/breeding/prediction_between_within_clade_body_mass_weibull_breeding.rds")
prediction_simple_h_breeding <- readRDS("revision_analysis/results/predictions/weibull/median/breeding/prediction_between_within_clade_HWI_Weibull_breeding.rds")
prediction_simple_l_breeding <- readRDS("Exports/results/prediction_2/weibull/median/breeding/prediction_between_within_clade_latitude_Weibull_breeding.rds")
prediction_simple_d_breeding <- readRDS("Exports/results/prediction_2/weibull/median/breeding/prediction_between_within_clade_distance_mig_Weibull_breeding.rds")
prediction_simple_p_breeding <- readRDS("Exports/results/prediction_2/weibull/median/breeding/prediction_between_within_clade_PC1_weibull_breeding.rds")
prediction_simple_die_breeding <- readRDS("Exports/results/prediction_2/weibull/median/breeding/prediction_between_within_clade_diet_weibull_breeding.rds")
prediction_simple_hab_breeding <- readRDS("Exports/results/prediction_2/weibull/median/breeding/prediction_between_within_clade_habitat_Weibull_breeding.rds")

prediction_breeding <- bind_rows(prediction_complex_breeding, prediction_simple_b_breeding, prediction_simple_h_breeding, prediction_simple_l_breeding, prediction_simple_d_breeding, prediction_simple_p_breeding,
                              prediction_simple_die_breeding,prediction_simple_hab_breeding )



validation <- prediction_breeding$validation 
validation$id <- c(1:nrow(validation)) 
prediction_breeding$id <- c(1:nrow(prediction_breeding)) 
validation_long <-
  prediction_breeding %>% 
...
export_validation <- validation_long %>% 
  dplyr::select(-model) 
write.csv(export_validation, "revision_analysis/results/predictions/weibull/median/breeding/prediction_median_breeding_complete.csv")
...
ggplot(sumrepdat2, aes(x = complexity, y = Mean_R2 , fill = type, group= type)) +
  ...
  coord_cartesian(ylim = c(0, 0.8), clip = "on")  + theme(text = element_text(size = 20))       
