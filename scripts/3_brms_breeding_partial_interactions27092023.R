...
results_breeding_weibull <- tibble(model = list(model_dispersal_f, model_long_dispersal_f), variable_selection= list(vs1, vs_long), type = "breeding", function_t= "best_model" )
save(results_breeding_weibull, file = "Exports/results/model_breeding_weibull_interactions.RData")