...
lista.modelos.natal <- list.files(path="./revision_analysis/results/weibull/natal/passerines",pattern='*.RData$', full.names=TRUE)
lapply(lista.modelos.natal,load,.GlobalEnv)
lista.modelos.breeding <- list.files(path="./revision_analysis/results/weibull/breeding/passerines",pattern='*.RData$', full.names=TRUE)
lapply(lista.modelos.breeding,load,.GlobalEnv)
lista.modelos.average <- list.files(path="./revision_analysis/results/weibull/average/passerines",pattern='*.RData$', full.names=TRUE)
...
save(results_total, file = "./revision_analysis/results/weibull/best_model_weibull_review_passerines.RData")
...
save(results_total_complete, file = "./revision_analysis/results/weibull/complete_model_weibull_review_passerines.RData")
