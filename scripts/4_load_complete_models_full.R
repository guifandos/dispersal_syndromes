...
lista.modelos <- list.files(path="./results/models/complete",pattern='*.RData$', full.names=TRUE)
lapply(lista.modelos,load,.GlobalEnv)


##########
results_total <- bind_rows(results_complete_average_models, results_complete_breeding_models, results_complete_natal_models)
results_total


results_total <- bind_rows(results_average_bestmodel, results_average_exponential, results_average_gamma, results_average_weibull, results_average_hcauchy,
                           results_breeding_bestmodel, results_breeding_exponential, results_breeding_gamma, results_breeding_weibull, results_breeding_hcauchy,
                           results_natal_bestmodel, results_natal_exponential, results_natal_gamma, results_natal_weibull, results_natal_hcauchy)
results_total

vector_long <- rep(c("median", "long"), nrow(results_total)/2)
results_total$dispersal_mode <- vector_long 
save(results_total, file = "results/model_total_complete_.RData")
