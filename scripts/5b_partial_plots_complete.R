...
data_model_average_weibull <- model_average_weibull %>%
  spread_draws(b_PC1, b_Latitude, b_log_body_mass, b_diet, b_habita_for, b_distance_mig, `b_log_body_mass:diet`, `b_log_body_mass:PC1`, `b_log_body_mass:habita_for`, b_log_HWI) %>%
  summarise_draws() %>% 
