...
loo_compare(model_dispersal_gauss_log_short, model_dispersal_gauss_log_complete, model_dispersal_negbin_complete ,model_dispersal_negbin_short, model_dispersal_negbin_short2, criterion = "loo")

pp <-loo_compare( model_dispersal_negbin_complete ,model_dispersal_negbin_short, model_dispersal_negbin_short2, criterion = "loo")
...
plot(simres)
dev.off()
compare_long <- loo_compare( model_long_dispersal_gauss_log_short2, model_long_dispersal_gauss_log_complete, criterion = "loo")
...
results_average_weibull <- tibble(model = list(best_median_model, best_long_model), variable_selection= list(cvvs, cvvs_long), age = "average", function_t= "best_model", type= c("median", "long") )
save(results_average_weibull, file = "revision_analysis/results/weibull/average/model_average_weibull_passerines.RData")
...
save(results_complete_average_models, file = "revision_analysis/results/weibull/average/model_average_complete_weibull_passerines.RData")
