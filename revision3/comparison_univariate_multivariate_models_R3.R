...
write.csv(loo_comparisons, "results/tables/loo_model_comparisons.csv", row.names = FALSE)
write.csv(model_type_summary, "results/tables/loo_model_type_summary.csv", row.names = FALSE)
write.csv(best_models, "results/tables/loo_best_models.csv", row.names = FALSE)
write.csv(competitive_models, "results/tables/loo_competitive_models.csv", row.names = FALSE)
write.csv(competitive_summary, "results/tables/loo_competitive_summary.csv", row.names = FALSE)
write.csv(uncertainty_analysis, "results/tables/loo_uncertainty_analysis.csv", row.names = FALSE)
write.csv(model_effectiveness, "results/tables/loo_model_effectiveness.csv", row.names = FALSE)
